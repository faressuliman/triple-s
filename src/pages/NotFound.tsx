...
const NotFound = () => {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-500 via-blue-300 to-cyan-200 relative overflow-hidden">
      ...
      <div className="relative z-10 text-center p-8 bg-white/80 rounded-xl shadow-xl backdrop-blur-md">
