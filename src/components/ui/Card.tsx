...
const ServiceCard = ({ icon: Icon, title, description, color }: IServices) => {
    ...
    return (
        <div className={`bg-white rounded-lg md:w-auto w-auto md:h-72 h-auto mx-auto shadow-lg hover:shadow-xl hover:shadow-indigo-300 lg:py-6 md:py-3 py-8 px-8 text-center transition-all duration-400 transform hover:scale-102 hover:-translate-y-3 relative overflow-hidden group hover:cursor-default`}>
